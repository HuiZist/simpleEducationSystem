...
<head>
<meta charset="utf-8">
<title>智能加工中心教学系统发布公告</title>
<?php 
	require ROOT_PATH.'includes/title.inc.php';
?>
<script type="text/javascript" src="js/code.js"></script>
<script type="text/javascript" src="js/notice_post.js"></script>
</head>
<body>
<?php 
...
<div id="notice_post">
	<h2>发布公告</h2>
	<form method="post" name="notice_post" action="?action=notice_post">
	<dl>
		<dt></dt>
		<dd><span>公告标题:&nbsp;</span><input type="text" name="title" class="text"/></dd>
